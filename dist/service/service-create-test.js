...
var serviceTestGen = /*#__PURE__*/function () {
  function serviceTestGen(tsPath, config) {
    _classCallCheck(this, serviceTestGen);
    ...
    this.template = config.templates.service;
  ...
  return serviceTestGen;
}();
var _default = serviceTestGen;
